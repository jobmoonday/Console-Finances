var finances = [
  ...
  for (var i = 1; i < finances.length; i++) {
    ...
    currentMonthNet=finances[i][1]
    previousMonthNet=finances[i-1][1]
    monthlyChangesTotal+=currentMonthNet-previousMonthNet
    
  }

  averageOfChanges = (monthlyChangesTotal/(totalMonths-1))
